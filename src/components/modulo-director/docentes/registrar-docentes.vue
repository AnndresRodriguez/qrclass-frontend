  ...
  <div class="d-flex justify-content-center">
    <div class="col-md-10 cssRegistro">
      ...
      <div>
        <br />
        <p>
          Para realizar el registro de docentes, por favor descargue el
          siguiente formato EXCEL
          <a href="/files/formato-qrclass-docentes.xlsx" download>
            Formato Excel QR CLASS UFPS</a
          >, o el formato en texto plano (txt)
          <a href="/files/formato-qrclass-docentes.txt" download>
      ...
      <div>
        <!-- <button class="btn btn-info" @click="registrarDocentesExcel">
        Registrar Docentes
      </button> -->
        <router-link class="btn btn-info" :to="{ name: 'docente-registro' }"
          >Volver</router-link
        >
      </div>
    </div>
...
var state = {
  tickets: [{ name: "Información acerca de los Docente" }],
  headers: ["Campos de Docente"],
  nombreMateria: "",
};
      ...
      axios
        ...
        .then((res) => {
          if (res.data.operation) {
            ...
            this.$router.replace({ name: "docente-registro" });
            console.log(res.data);
          } else {
            console.log(res.data);
            ...
            fireToast(
              ...
              "Ha ocurrido un error en el registro de los docentes, por favor intentelos nuevamente"
            );
            console.log("registrarDocentesExcel", error);
          }
        })
        .catch((err) => {
          console.log(err);
